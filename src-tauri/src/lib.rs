...
#[tauri::command]
fn api_server_complete_chat_request(
    request_id: String,
    response: serde_json::Value,
) -> Result<(), String> {
    run_guarded("api_server_complete_chat_request", || {
        api_server::complete_chat_request(request_id, response)
    })
}
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            app.manage(commands::interview_audio::InterviewAudioState::default());
            app.manage(commands::interview_asr::InterviewAsrState::default());
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api_server_complete_chat_request,
            ...
            commands::interview_audio::interview_audio_start_capture,
            commands::interview_audio::interview_audio_stop_capture,
            commands::interview_audio::interview_audio_start_system_capture,
            commands::interview_audio::interview_audio_stop_system_capture,
            commands::interview_asr::interview_asr_start_session,
            commands::interview_asr::interview_asr_push_audio,
            commands::interview_asr::interview_asr_stop_session,
