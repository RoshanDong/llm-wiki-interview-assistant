...
export type AsrProvider = "volcengine-streaming" | "openai" | "custom"
export type AsrResponseFormat = "json" | "verbose_json" | "diarized_json"
export type AsrChunkingStrategy = "auto" | "none"
...
interface AsrConfig {
  ...
  chunkingStrategy: AsrChunkingStrategy
}
...
interface WikiState {
  ...
  activeView: "chat" | "wiki" | "sources" | "search" | "graph" | "lint" | "review" | "interview" | "settings"
  llmConfig: LlmConfig
  asrConfig: AsrConfig
...
export type { WikiState, LlmConfig, AsrConfig, SearchApiConfig, EmbeddingConfig, MultimodalConfig, OutputLanguage, ProxyConfig, ScheduledImportConfig, SourceWatchConfig, ApiConfig }
