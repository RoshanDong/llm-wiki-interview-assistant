...
import {
  FileText, FolderOpen, Search, Network, ClipboardCheck, Settings, ArrowLeftRight, ClipboardList, Globe, MessageSquare, Mic,
} from "lucide-react"
...
const NAV_ITEMS: { view: NavView; icon: typeof FileText; labelKey: string }[] = [
  ...
  { view: "interview", icon: Mic, labelKey: "nav.interview" },
]
